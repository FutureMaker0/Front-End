// python은 대부분 class로 되어 있다.
// 자바스크립트는 클래스가 es6부터 나온 문법이다. 원래 있던 문법이 아니다.
// 그 전에는 생성자 함수로 사용했었다.
...
let robot4 = new NewFactory('브랜든');
// 100개의 객체를 생성할 때마다 역시 100개의 함수를 새로 만들고 있는 것이다.

// 자바스크립트에서의 class란 무엇일까?
